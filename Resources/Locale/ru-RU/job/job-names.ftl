...
job-name-city-administrator = городской администратор
job-name-administrator-secretary = секретарь администратора
job-name-cwu-head = глава ГСР
job-name-cwu-worker = работник ГСР
job-name-civil-defense-sector-commander = секторный командир
job-name-civil-defense-dispatcher = диспетчер
job-name-civil-defense-officer = офицер ГО
job-name-civil-defense-unit = юнит ГО
job-name-civil-defense-recruit = рекрут ГО
job-name-loyalist = лоялист
job-name-civilian = гражданский
job-name-vortigaunt-slave = вортигонт-раб
job-name-resistance-coordinator = координатор сопротивления
job-name-rebel = повстанец
job-name-vortigaunt-free = вортигонт свободный

JobCityAdministrator = городской администратор
JobAdministratorSecretary = секретарь администратора
JobCWUHead = глава ГСР
JobCWUWorker = работник ГСР
JobCivilDefenseSectorCommander = секторный командир
JobCivilDefenseDispatcher = диспетчер
JobCivilDefenseOfficer = офицер ГО
JobCivilDefenseUnit = юнит ГО
JobCivilDefenseRecruit = рекрут ГО
JobLoyalist = лоялист
JobCivilian = гражданский
JobVortigauntSlave = вортигонт-раб
JobResistanceCoordinator = координатор сопротивления
JobRebel = повстанец
JobVortigauntFree = вортигонт свободный
