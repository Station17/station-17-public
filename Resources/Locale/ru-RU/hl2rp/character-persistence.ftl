hl2rp-unsaveable-examine = [color=gray]Этот предмет не переносится между сессиями персонажа и не сохраняется.[/color]

hl2rp-contracts-terminal-insert-card = Вставьте CID карту.
hl2rp-contracts-terminal-already-has-contract = У вас уже есть активный контракт.
