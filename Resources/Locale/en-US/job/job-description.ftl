...
job-description-city-administrator = Placeholder role for City Administration.
job-description-administrator-secretary = Placeholder role for City Administration.
job-description-cwu-head = Placeholder role for Civil Workers Union.
job-description-cwu-worker = Placeholder role for Civil Workers Union.
job-description-civil-defense-sector-commander = Placeholder role for Civil Defense.
job-description-civil-defense-dispatcher = Placeholder role for Civil Defense.
job-description-civil-defense-officer = Placeholder role for Civil Defense.
job-description-civil-defense-unit = Placeholder role for Civil Defense.
job-description-civil-defense-recruit = Placeholder role for Civil Defense.
job-description-loyalist = Placeholder role for Civilians department.
job-description-civilian = Placeholder role for Civilians department.
job-description-vortigaunt-slave = Placeholder role for Civilians department.
job-description-resistance-coordinator = Placeholder role for Underground.
job-description-rebel = Placeholder role for Underground.
job-description-vortigaunt-free = Placeholder role for Underground.
