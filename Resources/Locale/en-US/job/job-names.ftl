...
job-name-city-administrator = City Administrator
job-name-administrator-secretary = Administrator Secretary
job-name-cwu-head = CWU Head
job-name-cwu-worker = CWU Worker
job-name-civil-defense-sector-commander = Sector Commander
job-name-civil-defense-dispatcher = Dispatcher
job-name-civil-defense-officer = Civil Defense Officer
job-name-civil-defense-unit = Civil Defense Unit
job-name-civil-defense-recruit = Civil Defense Recruit
job-name-loyalist = Loyalist
job-name-civilian = Civilian
job-name-vortigaunt-slave = Vortigaunt Slave
job-name-resistance-coordinator = Resistance Coordinator
job-name-rebel = Rebel
job-name-vortigaunt-free = Free Vortigaunt

JobCityAdministrator = City Administrator
JobAdministratorSecretary = Administrator Secretary
JobCWUHead = CWU Head
JobCWUWorker = CWU Worker
JobCivilDefenseSectorCommander = Sector Commander
JobCivilDefenseDispatcher = Dispatcher
JobCivilDefenseOfficer = Civil Defense Officer
JobCivilDefenseUnit = Civil Defense Unit
JobCivilDefenseRecruit = Civil Defense Recruit
JobLoyalist = Loyalist
JobCivilian = Civilian
JobVortigauntSlave = Vortigaunt Slave
JobResistanceCoordinator = Resistance Coordinator
JobRebel = Rebel
JobVortigauntFree = Free Vortigaunt
